      ...
      <tr>
        <td align="center">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#ffffff;border:1px solid #e4e4e7;border-radius:16px;padding:32px;">
            <tr>
              <td>
                <p style="margin:0 0 8px;font-size:13px;letter-spacing:0.08em;text-transform:uppercase;color:#71717a;">${APP_NAME}</p>
                ...
                <p style="margin:0;font-size:13px;line-height:1.5;color:#71717a;">If you did not create a ${APP_NAME} account, you can ignore this email.</p>
              </td>
            </tr>
          </table>
        </td>
